...
class PostController extends Controller
{
    ...
    public function view($post_id) {
        ...
        // return $likeCtr;
        // exit();
        $categories = Category::all();      //Checking the database redirect and pull it and post
        $comments = DB::table('users')
            ...
            ->get();
        return view('posts.view', ['posts' => $post, 'categories' => $categories, 'likeCtr' => $likeCtr, 'dislikeCtr' => $dislikeCtr, 'comments' => $comments]);
    ...
    public function like($id) {
        ...
        $like_user = Like::where(['user_id' => $loggedin_user, 'post_id' => $id])->first(); // auth! the same user cannot like the post twice
    ...
    public function dislike($id) {
        $loggedin_user = Auth::user()->id;
        $like_user = Dislike::where(['user_id' => $loggedin_user, 'post_id' => $id])->first(); // auth! the same user cannot like the post twice
        if(empty($like_user->user_id)) {
            $user_id = Auth::user()->id;
            $email = Auth::user()->email;
            $post_id = $id;
